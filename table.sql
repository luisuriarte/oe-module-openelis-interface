...
CREATE TABLE IF NOT EXISTS `mod_openelis_code_mapping` (
  ...
  `openelis_panel_id` varchar(20) DEFAULT NULL
      COMMENT 'Section grp code this test hangs from (OEP..-SEC-.., informational, not relational)',
  `openelis_panel_name` varchar(255) DEFAULT NULL
      COMMENT 'OpenELIS section/panel display name (informational, not relational)',
...
ALTER TABLE `mod_openelis_code_mapping`
  ...
  ADD COLUMN `openelis_panel_id` varchar(20) DEFAULT NULL
      COMMENT 'Section grp code this test hangs from (OEP..-SEC-.., informational, not relational)' AFTER `openelis_test_name`,
  ADD COLUMN `openelis_panel_name` varchar(255) DEFAULT NULL
      COMMENT 'OpenELIS section/panel display name (informational, not relational)' AFTER `openelis_panel_id`,
...
-- =============================================================================
-- The catalog REST API (GET /OpenELIS-Global/rest/TestCatalog) requires a
