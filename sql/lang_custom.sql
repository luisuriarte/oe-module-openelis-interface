...
('Spanish (Latin American)', 'el', 'Imports the OpenELIS test catalog (active tests, grouped by OpenELIS test section) into the OpenEMR lab procedure catalog, respecting each provider\'s own catalog. Manual code mappings are never overwritten.', 'Importa el catálogo de pruebas de OpenELIS (pruebas activas, agrupadas por sección de prueba de OpenELIS) al catálogo de procedimientos de laboratorio de OpenEMR, respetando el catálogo propio de cada proveedor. Los mapeos de códigos manuales nunca se sobrescriben.'),
...
('Spanish (Latin American)', 'el', 'No OpenELIS lab providers found. On the native Procedure Providers edit form, open your lab provider (the one named after your OpenELIS installation, e.g. OpenELIS) and set its OpenELIS Catalog Login / Password. A provider only appears here once those catalog credentials are saved.', 'No se encontraron proveedores de laboratorio OpenELIS. En el formulario nativo de proveedores, abra su proveedor de laboratorio (el que lleva el nombre de su instalación de OpenELIS, ej. OpenELIS) y configure su Usuario/Contraseña de Catálogo OpenELIS. Un proveedor solo aparece aquí cuando esas credenciales de catálogo están guardadas.'),
...
('Spanish (Latin American)', 'el', 'Incomplete (WS protocol / host)',                                      'Incompleto (protocolo WS / host)'),
('Spanish (Latin American)', 'el', 'Last import',                                                 'Última sincronización'),
('Spanish (Latin American)', 'el', 'Never',                                                       '—'),

-- public/catalog_import.php (UI result strings, JS via xl() -> TR)
('Spanish (Latin American)', 'el', 'Sections (groups)',                                           'Secciones (grupos)'),
('Spanish (Latin American)', 'el', 'Tests imported',                                              'Tests importados'),
('Spanish (Latin American)', 'el', 'Active tests in catalog',                                     'Tests activos en el catálogo'),
('Spanish (Latin American)', 'el', 'Groups created',                                              'Grupos creados'),
('Spanish (Latin American)', 'el', 'Groups updated',                                              'Grupos actualizados'),
('Spanish (Latin American)', 'el', 'Tests created',                                               'Tests creados'),
('Spanish (Latin American)', 'el', 'Tests updated',                                               'Tests actualizados'),
('Spanish (Latin American)', 'el', 'Mappings created',                                            'Mapeos creados'),
('Spanish (Latin American)', 'el', 'Mappings updated',                                            'Mapeos actualizados'),
('Spanish (Latin American)', 'el', 'Excluded (error)',                                            'Excluidos (error)'),
('Spanish (Latin American)', 'el', 'With warnings',                                               'Con advertencias'),
('Spanish (Latin American)', 'el', 'Inactive / not found',                                        'Inactivos / no encontrados'),
('Spanish (Latin American)', 'el', 'Conflicts with manual mappings',                               'Conflictos con mapeos manuales'),
('Spanish (Latin American)', 'el', 'Sample types without SNOMED',                                  'Muestras sin SNOMED'),
('Spanish (Latin American)', 'el', 'Sections deactivated',                                        'Secciones desactivadas'),
('Spanish (Latin American)', 'el', 'Tests deactivated',                                           'Tests desactivados'),
('Spanish (Latin American)', 'el', 'Sections reactivated',                                        'Secciones reactivadas'),
('Spanish (Latin American)', 'el', 'Tests reactivated',                                           'Tests reactivados'),
('Spanish (Latin American)', 'el', 'Excluded by error',                                           'Excluidos por error'),
('Spanish (Latin American)', 'el', 'With catalog warnings',                                       'Con advertencias de catálogo'),
('Spanish (Latin American)', 'el', 'Sample types without SNOMED code',                             'Tipos de muestra sin código SNOMED'),
('Spanish (Latin American)', 'el', 'Sections deactivated (absent from catalog)',                  'Secciones desactivadas (ausentes del catálogo)'),
('Spanish (Latin American)', 'el', 'Tests deactivated (absent from catalog)',                     'Tests desactivados (ausentes del catálogo)'),
('Spanish (Latin American)', 'el', 'Sections reactivated (back in catalog)',                      'Secciones reactivadas (volvieron al catálogo)'),
('Spanish (Latin American)', 'el', 'Tests reactivated (back in catalog)',                         'Tests reactivados (volvieron al catálogo)'),
('Spanish (Latin American)', 'el', 'No tests excluded by error.',                                 'Sin tests excluidos por error.'),
('Spanish (Latin American)', 'el', 'No tests with warnings.',                                     'Sin tests con advertencias.'),
('Spanish (Latin American)', 'el', 'No inactive tests.',                                          'Sin tests inactivos.'),
('Spanish (Latin American)', 'el', 'No conflicts with manual mappings.',                           'Sin conflictos con mapeos manuales.'),
('Spanish (Latin American)', 'el', 'All sample types have a SNOMED code.',                         'Todos los tipos de muestra tienen código SNOMED.'),
('Spanish (Latin American)', 'el', 'No sections deactivated.',                                    'Sin secciones desactivadas.'),
('Spanish (Latin American)', 'el', 'No tests deactivated.',                                       'Sin tests desactivados.'),
('Spanish (Latin American)', 'el', 'No sections reactivated.',                                    'Sin secciones reactivadas.'),
('Spanish (Latin American)', 'el', 'No tests reactivated.',                                       'Sin tests reactivados.'),
('Spanish (Latin American)', 'el', '{n} test',                                                    '{n} test'),
('Spanish (Latin American)', 'el', '{n} tests',                                                   '{n} pruebas'),
('Spanish (Latin American)', 'el', 'Example: {name}. Fill in the SNOMED code in mod_openelis_specimen_map and re-import.', 'Ejemplo: {name}. Complete el código SNOMED en mod_openelis_specimen_map y vuelva a importar.'),
('Spanish (Latin American)', 'el', 'Manual mapping: {code} — auto import skipped (manual mapping prevails).', 'Mapeo manual: {code} — importación automática omitida (el mapeo manual prevalece).'),
('Spanish (Latin American)', 'el', 'DRY RUN — nothing was written to the database. Review the summary, then confirm the import.', 'SIMULACIÓN — no se escribió nada en la base de datos. Revise el resumen y confirme la importación.'),
('Spanish (Latin American)', 'el', 'Import completed for {provider}.',                            'Importación completada para {provider}.'),
('Spanish (Latin American)', 'el', 'Select a lab provider.',                                      'Seleccione un proveedor de laboratorio.'),
('Spanish (Latin American)', 'el', 'Waiting...',                                                  'Esperando...'),
('Spanish (Latin American)', 'el', 'Unknown error',                                               'Error desconocido'),
('Spanish (Latin American)', 'el', '— Legacy (no provider) —',                                    '— Legacy (sin proveedor) —'),
